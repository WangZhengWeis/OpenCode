...
var ReferrerKiller = (function () {
    ...
    /**
	 * It displays an iframe without sending the referrer.
	 *
	 * @public
	 * @param {String} url
	 ...
	 * @return {String} html
	 */
	var iframeHtml = PUB.iframeHtml = function (url, iframeAttributesParam) {
		var iframeAttributes = iframeAttributesParam || {};
		return htmlString('<iframe src="' + escapeDoubleQuotes(url) + '" ' + objectToHtmlAttributes(iframeAttributes) + ' ></iframe>');
	};
	 ...
	 * @return {String} html
	 */
	var iframeNode = PUB.iframeNode = function (url, iframeAttributesParam) {
        htmlToNode(iframeHtml(url, iframeAttributesParam));
	};
