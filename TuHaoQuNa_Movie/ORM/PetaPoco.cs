...
namespace ORM
{
    ...
    public class Database : IDisposable
    {
        ...
        public Database(string connectionStringName)
        {
            ...
            //_connectionString = InEncrypt.Decode(ConfigurationManager.ConnectionStrings[connectionStringName].ConnectionString, "huangleiDB");
        ...
        public IDbCommand CreateCommand(IDbConnection connection, string sql, params object[] args)
        {
            ...
            if (_dbType == DBType.Oracle)
            {
                var b = cmd.GetType().GetProperty("BindByName");
                if (b != null)
                    b.SetValue(cmd, true, null);
            }
